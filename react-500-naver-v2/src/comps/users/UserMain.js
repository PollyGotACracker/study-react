...
const HeaderComps = ({ path }) => {
  return path.includes("login") ? (
    <h1 className="w3-blue w3-center">로그인</h1>
  ) : (
    <h1 className="w3-green w3-center">회원가입</h1>
  );
};
...
const UserMain = () => {
  ...
  return (
    <CardMain
      width="50%"
      maxHeight="80vh"
      header={<HeaderComps path={resolvePath.pathname} />}
 ...
 * link 를 클릭했을 때 URL jump 기능은 무력화(href="#" 대체)
 */
