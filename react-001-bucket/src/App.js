 ...
 * 일반적으로 *.css 파일에 style 을 지정하고 import 하여 사용하는데,
 * 이때 style 이 Global 로 적용되므로 style 이 충돌하여
 * 예기치 못한 Layout 혼란이 올 수 있다.
 *
 * Component 코드에서 CSS 를 JS 객체로 선언하고
 * 적용하면 현재 Componenet 에서만 적용되는 private CSS 를 구현할 수 있다.
 */
const headerStyle = {
